...
`;function d({quest:e}){return(0,l.jsxs)(`div`,{className:`qs-media cga-frame w-full h-full`,style:{aspectRatio:String(e.ratio)},children:[e.video?(0,l.jsx)(`video`,{className:`cga-media`,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:`metadata`,poster:e.thumb,children:(0,l.jsx)(`source`,{src:e.video,type:e.video.endsWith(`.webm`)?`video/webm`:`video/mp4`})}):(0,l.jsx)(`img`,{className:`cga-media`,src:e.thumb,alt:``,loading:`lazy`}),(0,l.jsx)(`div`,{className:`cga-duo`}),(0,l.jsx)(`div`,{className:`cga-dither`}),(0,l.jsx)(`div`,{className:`qs-scrim`}),(0,l.jsx)(`h3`,{className:`qs-title lowercase`,children:e.name})]})}function f({quest:e,index:t}){return(0,l.jsxs)(`div`,{className:`mt-3 flex items-baseline justify-between font-mono text-xs text-base-400`,children:[(0,l.jsxs)(`span`,{children:[(0,l.jsxs)(`span`,{className:`text-accent-400`,children:[`lv `,String(t+1).padStart(2,`0`)]}),` · `,e.year,e.tags.length>0&&(0,l.jsxs)(`span`,{className:`text-base-500`,children:[` · `,e.tags.join(` / `)]})]}),(0,l.jsx)(`span`,{className:`qs-cta text-accent-400`,children:`view quest →`})]})}var p=`min(38vh, 355px)`;function m({quest:e,index:t}){return(0,l.jsxs)(`a`,{href:`/grogger.io/projects/${e.slug}`,className:`qs-slide cga-group group shrink-0`,style:{width:`calc(${p} * ${e.ratio})`},children:[(0,l.jsx)(d,{quest:e}),(0,l.jsx)(f,{quest:e,index:t})]})}function h({quests:e}){let t=(0,c.useRef)(null),n=(0,c.useRef)(null),a=(0,c.useRef)(null),[u,d]=(0,c.useState)([0,0]),f=e.filter((e,t)=>t%2==0),p=e.filter((e,t)=>t%2==1);(0,c.useLayoutEffect)(()=>{let e=()=>{let e=e=>e?Math.max(0,e.scrollWidth-window.innerWidth):0;d([e(n.current),e(a.current)])};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let h=Math.max(u[0],u[1]),{scrollYProgress:g}=i({target:t,offset:[`start start`,`end end`]}),_=s(g,{stiffness:120,damping:24,mass:.4}),v=e=>Math.min(1,Math.max(0,(e-.04)/(.85-.04))),y=o(_,e=>-(u[0]*v(e))),b=o(_,e=>-(u[1]*v(e))),x=o(g,e=>`${(v(e)*100).toFixed(1)}%`),S=o(g,t=>String(Math.max(1,Math.min(e.length,Math.floor(v(t)*e.length)+1))).padStart(2,`0`));return(0,l.jsx)(`div`,{ref:t,style:{height:`calc(100vh + ${Math.round(h*1.23)}px)`},children:(0,l.jsx)(`div`,{className:`sticky top-0 h-screen overflow-hidden flex flex-col justify-center`,children:(0,l.jsxs)(r.div,{className:`relative flex flex-col justify-center h-full`,initial:{opacity:0,scaleY:.02},whileInView:{opacity:1,scaleY:1},viewport:{once:!0,amount:.2},transition:{duration:.7,ease:[.16,1,.3,1]},children:[(0,l.jsx)(`div`,{className:`qs-corner border-t-2 border-l-2`,style:{top:`4vh`,left:`3vw`}}),(0,l.jsx)(`div`,{className:`qs-corner border-t-2 border-r-2`,style:{top:`4vh`,right:`3vw`}}),(0,l.jsx)(`div`,{className:`qs-corner border-b-2 border-l-2`,style:{bottom:`4vh`,left:`3vw`}}),(0,l.jsx)(`div`,{className:`qs-corner border-b-2 border-r-2`,style:{bottom:`4vh`,right:`3vw`}}),(0,l.jsx)(`div`,{className:`absolute left-[6vw] right-[6vw] flex justify-between font-mono text-xs text-base-400`,style:{top:`4vh`},children:(0,l.jsxs)(`span`,{children:[`> quest.log --scroll ·`,` `,(0,l.jsx)(r.span,{className:`text-accent-400`,children:S}),` / `,String(e.length).padStart(2,`0`)]})}),(0,l.jsxs)(`div`,{className:`flex flex-col justify-center gap-[2vh]`,children:[(0,l.jsx)(r.div,{ref:n,style:{x:y},className:`flex items-end gap-[2.5vw] pl-[10vw] pr-[14vw] will-change-transform`,children:f.map((e,t)=>(0,l.jsx)(m,{quest:e,index:t*2},e.slug))}),(0,l.jsx)(r.div,{ref:a,style:{x:b},className:`flex items-start gap-[2.5vw] pl-[16vw] pr-[10vw] will-change-transform`,children:p.map((e,t)=>(0,l.jsx)(m,{quest:e,index:t*2+1},e.slug))})]}),(0,l.jsxs)(`div`,{className:`absolute left-[6vw] right-[6vw] flex items-center gap-4`,style:{bottom:`4vh`},children:[(0,l.jsx)(`div`,{className:`h-1 flex-1 rounded-full bg-white/10 overflow-hidden`,children:(0,l.jsx)(r.div,{className:`h-full rounded-full`,style:{width:x,background:`linear-gradient(90deg, #4df3ff, #ff4fd8)`}})}),(0,l.jsx)(`span`,{className:`font-mono text-[10px] text-base-500`,children:`xp`})]})]})})})}function g({quests:e}){return(0,l.jsx)(`div`,{className:`mx-auto max-w-5xl px-6 flex flex-col gap-10 py-6`,children:e.map((e,t)=>(0,l.jsxs)(`a`,{href:`/grogger.io/projects/${e.slug}`,className:`qs-slide cga-group group`,children:[(0,l.jsx)(d,{quest:e}),(0,l.jsx)(f,{quest:e,index:t})]},e.slug))})}function _({quests:e}){let[t,n]=(0,c.useState)(null),r=a();return(0,c.useEffect)(()=>{let e=window.matchMedia(`(min-width: 768px)`),t=()=>n(r||!e.matches?`v`:`h`);return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[r]),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`style`,{children:u}),t===`h`&&(0,l.jsx)(h,{quests:e}),t===`v`&&(0,l.jsx)(g,{quests:e})]})}export{_ as default};